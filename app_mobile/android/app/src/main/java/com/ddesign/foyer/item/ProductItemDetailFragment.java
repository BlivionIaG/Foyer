 ...
 * on handsets.
 */
public class ProductItemDetailFragment extends Fragment {
    /**
     ...
     */
    public ProductItemDetailFragment() {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            mItem = (ProduitItem) Content.PRODUCT_ITEMS.get(Integer.parseInt(getArguments().getString(ARG_ITEM_ID)));
